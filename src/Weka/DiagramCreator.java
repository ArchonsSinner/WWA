...
public class DiagramCreator {
	...
	public static String createClusterSizeBarChart(Cluster[] clusters) {
		...
		JFreeChart myBarChart = ChartFactory.createBarChart("Clustergr��e", "Cluster Nr", "Anz Pers", myDataset,PlotOrientation.VERTICAL,false,true,false);
	...
	public static String createItemCountPerCluster(Cluster cluster) {
		...
		JFreeChart myBarChart1 = ChartFactory.createBarChart("Anteil der K�ufe der Warengruppen\nCluster " + cluster.getIndex()+" ("+cluster.getSize()+")",
	...
	public static String createWeekdayPieChart(Cluster cluster) {
		...
		JFreeChart myPieChart = ChartFactory.createPieChart("Eink�ufe pro Wochentag\nCluster " + cluster.getIndex()+" ("+cluster.getSize()+")",
				myDataset);
