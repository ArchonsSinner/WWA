...
public class DataControl extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        try {
            ...
            for(int i=0; i<map.size(); i++){
                out.print("<a href='/Weka/old_helper?clust=" + old_num_cluster[i] + "&path=" + old_filenames[i] + "'>" + old_filenames[i].substring(old_filenames[i].length()-60) + " Cluster: " + old_num_cluster[i] + "</a><br>");
            }
